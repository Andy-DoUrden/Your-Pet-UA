import{v as y,b as K,a as he,j as e,h as d,s as x,r as b,S as ue,U as ge,C as fe}from"./index-80a5c5ac.js";import{a as m,c as I,b as j,e as F,F as $,E as u,d as Q,g as be}from"./index.esm-d4bbc291.js";const q=y(m)`
  display: none;
`,je=y.div`
  display: flex;
...
`,ke=I({category:j().required("Select a category")}),Pe=n=>{const t=K(),s=he(),l=()=>{s.state?t(s.state.from):t("/user")},r=g=>{n.next(g)};return e.jsx(F,{initialValues:n.data,validationSchema:ke,onSubmit:r,children:e.jsxs($,{children:[e.jsxs(je,{children:[e.jsx(q,{type:"radio",name:"category",id:"your-pet",value:"your-pet"}),e.jsx("label",{htmlFor:"your-pet",children:"ваш улюбленець"}),e.jsx(q,{type:"radio",name:"category",id:"sell",value:"sell"}),e.jsx("label",{htmlFor:"sell",children:"продаж"}),e.jsx(q,{type:"radio",name:"category",id:"lost-found",value:"lost-found"}),e.jsx("label",{htmlFor:"lost-found",children:"загубив(ла)/знайшов(ла)"}),e.jsx(q,{type:"radio",name:"category",id:"in-good-hands",value:"in-good-hands"}),e.jsx("label",{htmlFor:"in-good-hands",children:"в хороші руки"}),e.jsx(u,{name:"category",component:ye})]}),e.jsxs(z,{children:[e.jsxs(v,{className:"buttonNext",type:"submit",children:["Далі",e.jsx(C,{children:e.jsx("use",{href:d+"#iconPaw"})})]}),e.jsxs(v,{className:"buttonBack",type:"button",onClick:l,to:s.state.from,children:[e.jsx(M,{children:e.jsx("use",{href:d+"#iconArrowLeft"})}),"Відміна"]})]})]})})},X=y.div`
...
`,Ie=I({title:j().matches(/^([А-ЩЬЮЯҐЄIЇІІа-щьюяґєіїьі]+\s?){1,}$/iu,"Допустимі тільки Українські символи").min(2,"Заголовок повинен містити від 2 символів").max(20,"Заголовок повинен містити до 20 символів").required("Введіть заголовок"),name:j().matches(/^([А-ЩЬЮЯҐЄIЇІІа-щьюяґєіїьі]+\s?){1,}$/iu,"Допустимі тільки Українські символи").min(2,"Ім'я повинне містити від 2 символів").max(16,"Ім'я повинне містити до 16 символів").required("Введіть ім'я"),date:Q().required("Введіть дату народження").max(new Date,"Дата народження не може бути у майбутньому"),type:j().matches(/^([А-ЩЬЮЯҐЄIЇІІа-щьюяґєіїьі]+\s?){1,}$/iu,"Допустимі тільки Українські символи").min(2,"Порода повинна містити від 2 символів").max(16,"Порода повинна містити до 16 символів").required("Введіть породу")}),Fe=n=>{const t=s=>{n.next(s)};return e.jsx(F,{initialValues:n.data,validationSchema:Ie,onSubmit:t,children:({values:s,touched:l,errors:r})=>e.jsxs($,{children:[e.jsxs(X,{children:[e.jsxs("label",{children:["Заголовок",e.jsx(m,{type:"text",name:"title",placeholder:"Заголовок",className:`${l.title&&r.title?"is-invalid":""}`}),e.jsx(u,{name:"title",component:k})]}),e.jsxs("label",{children:["Ім'я",e.jsx(m,{type:"text",name:"name",placeholder:"Type name pet",className:`${l.name&&r.name?"is-invalid":""}`}),e.jsx(u,{name:"name",component:k})]}),e.jsxs("label",{children:["Дата народження",e.jsx(m,{name:"date",type:"date",placeholder:"Вкажіть дату народження",className:`${l.date&&r.date?"is-invalid":""}`}),e.jsx(u,{name:"date",component:k})]}),e.jsxs("label",{children:["Порода",e.jsx(m,{type:"text",name:"type",placeholder:"Вкажіть породу",className:`${l.type&&r.type?"is-invalid":""}`}),e.jsx(u,{name:"type",component:k})]})]}),e.jsxs(z,{children:[e.jsxs(v,{className:"buttonNext",type:"submit",children:["Далі",e.jsx(C,{children:e.jsx("use",{href:d+"#iconPaw"})})]}),e.jsxs(v,{className:"buttonBack",type:"button",onClick:()=>n.prev(s),children:[e.jsx(M,{children:e.jsx("use",{href:d+"#iconArrowLeft"})}),"Назад"]})]})]})})},$e=I({name:j().matches(/^([А-ЩЬЮЯҐЄIЇІІа-щьюяґєіїьі]+\s?){1,}$/iu,"Допустимі тільки Українські символи").min(2,"Ім'я повинне містити від 2 символів").max(16,"Ім'я повинне містити до 16 символів").required("Введіть ім'я"),date:Q().required("Введіть дату народження").max(new Date,"Дата народження не може бути у майбутньому"),type:j().matches(/^([А-ЩЬЮЯҐЄIЇІІа-щьюяґєіїьі]+\s?){1,}$/iu,"Допустимі тільки Українські символи").min(2,"Порода повинна містити від 2 символів").max(16,"Порода повинна містити до 16 символів").required("Введіть породу")}),ze=n=>{const t=s=>{n.next(s)};return e.jsx(F,{initialValues:n.data,validationSchema:$e,onSubmit:t,children:({values:s,touched:l,errors:r})=>e.jsxs($,{children:[e.jsxs(X,{children:[e.jsxs("label",{children:["Ім'я улюбленця",e.jsx(m,{type:"text",name:"name",placeholder:"Введіть ім'я",className:`${l.name&&r.name?"is-invalid":""}`}),e.jsx(u,{name:"name",component:k})]}),e.jsxs("label",{children:["Дата народження",e.jsx(m,{type:"date",name:"date",placeholder:"Кажіть дату народження",className:`${l.date&&r.date?"is-invalid":""}`}),e.jsx(u,{name:"date",component:k})]}),e.jsxs("label",{children:["Порода",e.jsx(m,{type:"text",name:"type",placeholder:"Вкажіть породу",className:`${l.type&&r.type?"is-invalid":""}`}),e.jsx(u,{name:"type",component:k})]})]}),e.jsxs(z,{children:[e.jsxs(v,{className:"buttonNext",type:"submit",children:["Далі",e.jsx(C,{children:e.jsx("use",{href:d+"#iconPaw"})})]}),e.jsxs(v,{className:"buttonBack",type:"button",onClick:()=>n.prev(s),children:[e.jsx(M,{children:e.jsx("use",{href:d+"#iconArrowLeft"})}),"Назад"]})]})]})})},R=x.img`
